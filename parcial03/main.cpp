 ...
 * Tópico: Parcial 03
 * Requerimientos:
 * - Realizar un análiss de datos sobre el dataset seleccionado
 * - Modelar el dataset mediante una regresión lineal en C++
 * - Modelar el dataset mediante una regresión lineal en Python
